// Copa del Mundo (trofeo dorado) — SVG inline, escalable vía prop `size`.
    ...
    >
      <defs>
        <linearGradient id="mp-trophy-gold" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="1" stopColor="#a87f28" />
        </linearGradient>
      </defs>
      ...
      />
      {/* Base */}
      <rect x="18" y="36.4" width="12" height="2.4" rx="1" fill="url(#mp-trophy-gold)" stroke="#8c6a22" strokeWidth="0.6" />
      <rect x="15.5" y="39.2" width="17" height="3" rx="1.2" fill="url(#mp-trophy-gold)" stroke="#8c6a22" strokeWidth="0.6" />
      <rect x="13" y="42.6" width="22" height="2.6" rx="1.2" fill="#7a5c1e" />
    </svg>
  );
}

  ...
  partidos: [
    {
      ...
      referee: { name: "Maurizio Mariani", avgCards: "4.0", avgFouls: "25.2" },
    ...
    },
    {
      ...
      avoid: ["Brasil -1.5 solo ~38%: puede ganar 1-0 de contra", "Turpin permisivo (3.2): NADA de over de tarjetas pese a la tensión"],
      picks: {
        klement: { market: "1X2", selection: "Brasil", driver: "ranking + plantel", options: [{ market: "1X2", selection: "Brasil gana", confidence: "alta" }] },
        claude: {
          market: "1X2 + Goles",
          selection: "Brasil gana o empata + valor en goles",
          note: "61% Brasil. Escocia obligada se abre → BTTS y contras de Brasil. Jugador: Vini/Raphinha al espacio; Brasil córners.",
          options: [{ market: "Doble oportunidad", selection: "Brasil o empate", confidence: "alta" }, { market: "1X2", selection: "Brasil gana", confidence: "media" }, { market: "BTTS", selection: "Sí", confidence: "media" }, { market: "Córners", selection: "Brasil over", confidence: "media" }],
    ...
    },
    {
      ...
      oddsNote: "Marruecos 1.32 / X 5.0 / Haití 9.0. Valor en hándicap, córners y tarjetas.",
      avoid: ["Ganar no paga: ir por -1.5/córners", "Haití desinflado puede bajar su intensidad de falta"],
      picks: {
        klement: { market: "1X2", selection: "Marruecos", driver: "ranking + forma", options: [{ market: "1X2", selection: "Marruecos gana", confidence: "alta" }] },
        claude: {
          market: "Hándicap + Tarjetas",
          selection: "Marruecos -1.5 + amarillas over",
          note: "76% gana. Valenzuela es el 4.º árbitro más tarjetero (5.1) y Haití defiende profundo → total de amarillas a la alza pese al desánimo. Jugador: Hakimi/Ziyech córners y tiros vs bloque.",
          options: [{ market: "Hándicap", selection: "Marruecos -1.5", confidence: "media" }, { market: "Córners", selection: "Marruecos over", confidence: "alta" }, { market: "1X2", selection: "Marruecos gana", confidence: "alta" }, { market: "Tarjetas", selection: "Total amarillas Over 4.5", confidence: "media" }],
    ...
    },
    {
      ...
      picks: {
        ...
        claude: {
          market: "1X2 / Doble oportunidad",
          selection: "México o empate",
          note: "54% México pero con riesgo de rotación. La altitud es el gran factor. Jugador: México maneja el balón; Chequia se desgasta en altura.",
          options: [{ market: "Doble oportunidad", selection: "México o empate", confidence: "media" }, { market: "Totales", selection: "Under 3.5", confidence: "media" }, { market: "1X2", selection: "México gana", confidence: "baja" }],
    ...
    },
    {
      ...
      picks: {
        ...
        claude: {
          market: "1X2 + factor calor",
          selection: "Sudáfrica o empate (valor)",
          note: "Partido parejo (36/28/36). El calor de Monterrey da a Sudáfrica ventaja de cierre físico → su doble oportunidad tiene valor a la cuota. Jugador: choque físico; ojo 2.ª mitad.",
          options: [{ market: "Doble oportunidad", selection: "Sudáfrica o empate", confidence: "media" }, { market: "Totales", selection: "Under 2.5", confidence: "media" }, { market: "BTTS", selection: "Sí", confidence: "media" }],
...
export const DUAL_JORNADAS: DualJornada[] = [j1, j2, j3, j4, j9, j10, j11, j12, j13, j14, j15, j16];
